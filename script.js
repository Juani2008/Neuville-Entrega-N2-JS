...
const producto = [
    ...
    {marca:"moYu",tipo:"2x2",precio:"600",imagen:"<img  src=\"images/dayan2x2.jfif\" alt=\"\">",id:2, logo: "images/moyu.png"},
    {marca:"dayan",tipo:"4x4",precio:"300",imagen:"<img  src=\"images/moyu4x4.jfif\" alt=\"\">",id:3, logo: "images/dayan.jfif"},
...
const mostrarCarrito = () =>{
    ...
    noRepetir.forEach((prod) =>{
        ...
        <p>Cantidad: <strong> ${cantidadCar}</strong></p>
        <p>Precio Individual: ${precioCar}</p>
        <p>Precio Total por Produ: ${totalProd}</p>
        <hr>
        `;
